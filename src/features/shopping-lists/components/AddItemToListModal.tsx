...
import { UNIT_TYPES as UNIT_OPTIONS } from '../../../shared/constants/categories';
...
const AddItemToListModal: React.FC<AddItemToListModalProps> = ({
  ...
  useEffect(() => {
    if (showSuggestions && inputRef.current) {
      ...
      setDropdownPosition({
        top: rect.bottom + 4,  // No scroll offset for fixed positioning
        left: rect.left,       // No scroll offset for fixed positioning
        width: rect.width,
      });
    }
