...
import { parseListText, ParsedItem, normalizeUnit } from '../../../utils/listParser';
import { fuzzyMatchItem } from '../../../services/fuzzyMatchService';
...
export const PasteListModal: React.FC<PasteListModalProps> = ({
    ...
    const matchItem = (parsedItem: ParsedItem, items: Item[]): MatchedItem => {
        const result = fuzzyMatchItem(parsedItem.itemName, items);
