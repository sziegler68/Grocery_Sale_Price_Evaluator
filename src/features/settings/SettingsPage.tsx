    ...
    const handleSyncTax = async () => {
        ...
        try {
            ...
            if (jurisdiction) {
                ...
                toast.success(`✓ Found tax rate for ${jurisdiction.city}, ${jurisdiction.state_code}: ${percentageRate}%`);
            } else {
                // Save zip code even if rate not found
                saveZipCode(zipCode);
                setZipValidationWarning(`Zip code ${zipCode} not found in our database. Please enable "Manual Override" below to set your tax rate.`);
                toast.warning('Zip code saved, but tax rate not found. Please set manually.');
                // Enable manual override to help user
                setTaxOverride(true);
                saveTaxRateOverride(true);
            }
        } catch (error) {
            console.error('Failed to sync tax:', error);
            toast.error('Failed to lookup tax rate. Please check your internet connection.');
        } finally {
                ...
                <div className="bg-card rounded-lg shadow-lg p-6 border border-primary mt-6">
                    ...
                    <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                        <p className="text-xs text-blue-800 dark:text-blue-200">
                            <strong>ℹ️ Coverage:</strong> We have tax rates for the top 50 US cities. If your zip code isn't found, you can manually enter your local tax rate.
                        </p>
                    </div>
